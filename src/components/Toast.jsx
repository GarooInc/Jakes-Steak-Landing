...
const Toast = ({ message, type = 'error', onClose, duration = 5000 }) => {
  ...
  const baseStyles = "fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 rounded-lg shadow-lg transform transition-all duration-800 flex items-center gap-2 min-w-[320px] z-50";
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className={`rounded-lg p-1.5 hover:bg-opacity-80-gray-200 ${iconStyles[type]}`}
          >
            <CloseIcon />
          </button>
        </div>
