    ...
    >
      ...
      <div className="">
        ...
        <div className="bg-[#f2b92b] flex  flex-row  items-center justify-center gap-5 px-3 md:px-8 py-10 md:py-16 league-gothic relative">
          ...
          <a
              href="https://share.google/yAZEC1lOGxoEN6fVt"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 md:gap-4 text-[#1c5234] cursor-pointer"
            >
          ...
          <a
              href="mailto:info@jakesnysteak.com"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 md:gap-4 text-[#1c5234] cursor-pointer"
            >
          <div className="flex items-center gap-1 md:gap-4 text-[#1c5234] ">
           ...
           <a
              href="https://www.instagram.com/jakes.new.york.steak/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 md:gap-4 text-[#1c5234] cursor-pointer"
            >
              ...
              <span className="text-base md:text-[38px] uppercase text-nowrap">
                Take a Look
              </span>
            </a>
